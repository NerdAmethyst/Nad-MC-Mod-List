...
| [Debugify](https://modrinth.com/mod/debugify) | [isxander](https://modrinth.com/user/isxander) | 1.21.7 | ✅ | 🟡 | Fixes Minecraft bugs found on the bug tracker. | 🔸[YetAnotherConfigLib (YACL)](https://modrinth.com/mod/yacl)<br> 🔸[Fabric API](https://modrinth.com/mod/fabric-api)<br> 🔸[*Mod Menu**](https://modrinth.com/mod/modmenu) |
| [Dynamic FPS](https://modrinth.com/mod/dynamic-fps) | [juliand665](https://modrinth.com/user/juliand665) | 1.21.7 | ✅ | 🟢 | Reduce resource usage while Minecraft is in the background or idle. | 🔸[Fabric API](https://modrinth.com/mod/fabric-api)<br> 🔸[*Mod Menu**](https://modrinth.com/mod/modmenu)<br> 🔸[*Cloth Config API**](https://modrinth.com/mod/cloth-config) |
...
| [Entity Culling](https://modrinth.com/mod/entityculling) | [tr7zw](https://modrinth.com/user/tr7zw) | 1.21.7 | ✅ | 🟢 | Using async path-tracing to hide Block-/Entities that are not visible. | [Fabric API](https://modrinth.com/mod/fabric-api) |
...
| [ImmediatelyFast](https://modrinth.com/mod/immediatelyfast) | [RaphiMC](https://modrinth.com/user/RaphiMC) | 1.21.7 | ✅ | 🟢 | Speed up immediate mode rendering in Minecraft. | *none* |
...
| [Lithium](https://modrinth.com/mod/lithium) | [jellysquid3](https://modrinth.com/user/jellysquid3 "Original Author")<br> [2No2Name](https://modrinth.com/user/2No2Name "Project Lead") | 1.21.7 | ✅ | 🟢 | No-compromises game logic optimization mod. Well-suited for clients and servers of all kinds. | *none* |
...
| [ScalableLux](https://modrinth.com/mod/scalablelux) | [ishland](https://modrinth.com/user/ishland) | 1.21.7 | ❌ | 🟡 | A Fabric mod based on Starlight that improves the performance of light updates in Minecraft. | *none* |
...
| [Sodium](https://modrinth.com/mod/sodium) | [jellysquid3](https://modrinth.com/user/jellysquid3 "Project Lead")<br> [IMS](https://modrinth.com/user/IMS "Maintainer") | 1.21.7 | ✅ | 🟢 | The fastest and most compatible rendering optimization mod for Minecraft. | *none* |
...
| [Iris Shaders](https://modrinth.com/mod/iris) | [coderbot](https://modrinth.com/user/coderbot) | 1.21.7 | ✅ | 🟢 | A modern shader pack loader for Minecraft intended to be compatible with existing OptiFine shader packs. | [Sodium](https://modrinth.com/mod/sodium) |
| [LambDynamicLights](https://modrinth.com/mod/lambdynamiclights) | [LambdAurora](https://modrinth.com/user/LambdAurora) | 1.21.7 | ✅ | 🟢 | The most feature-complete dynamic lighting mod for Fabric. | [Fabric API](https://modrinth.com/mod/fabric-api) |
...
| [Beautified Chat \[Client\]](https://modrinth.com/mod/beautified-chat-client) | [Serilum](https://modrinth.com/user/Serilum) | 1.21.7 | ❌ | 🟡 | A highly configurable mod to change the chat style and colour on the client. | [Collective](https://modrinth.com/mod/collective) |
| [Beautified Chat \[Server\]](https://modrinth.com/mod/beautified-chat-server) | [Serilum](https://modrinth.com/user/Serilum) | 1.21.7 | ❌ | 🟡 | A highly configurable mod to change the style and colour of chat messages server-wide. | [Collective](https://modrinth.com/mod/collective) |
| [Dismount Entity](https://modrinth.com/mod/dismount-entity) | [Serilum](https://modrinth.com/user/Serilum) | 1.21.7 | ✅ | 🟡 | Allows players to dismount/remove/exit entities/mobs from mounted entities without breaking them. | [Collective](https://modrinth.com/mod/collective) |
| [Double Doors](https://modrinth.com/mod/double-doors) | [Serilum](https://modrinth.com/user/Serilum) | 1.21.7 | ❌ | 🟡 | Adds the ability for identical double doors, trapdoors and fence gates to be opened simultaneously. | [Collective](https://modrinth.com/mod/collective) |
| [Infinite Trading](https://modrinth.com/mod/infinite-trading) | [Serilum](https://modrinth.com/user/Serilum) | 1.21.7 | ✅ | 🟡 | Prevents villager trades from locking up, making them always available. | [Collective](https://modrinth.com/mod/collective) |
...
| [No Feather Trample](https://modrinth.com/mod/no-feather-trample) | [Serilum](https://modrinth.com/user/Serilum) | 1.21.7 | ✅ | 🟠 | Prevents farmland blocks from being trampled while having Feather/Slow Falling. | [Collective](https://modrinth.com/mod/collective) |
| [Scaffolding Drops Nearby](https://modrinth.com/mod/scaffolding-drops-nearby) | [Serilum](https://modrinth.com/user/Serilum) | 1.21.7 | ✅ | 🟡 | When breaking a scaffolding block, all chained blocks will drop at the block's position. | [Collective](https://modrinth.com/mod/collective) |
...
| [Stack Refill](https://modrinth.com/mod/stack-refill) | [Serilum](https://modrinth.com/user/Serilum) | 1.21.7 | ✅ | 🟡 | Automatically refills the item stack in the player's hand if there is any of the same item in the inventory. | [Collective](https://modrinth.com/mod/collective) |
| [Tree Harvester](https://modrinth.com/mod/tree-harvester) | [Serilum](https://modrinth.com/user/Serilum) | 1.21.7 | ✅ | 🟡 | Harvest full trees and huge mushrooms instantly with an axe. Includes fast leaf decay and sapling placement. | [Collective](https://modrinth.com/mod/collective) |
...
| **Name** | **Author** | **Game Version** | **Status** | **Priority** | **Description** | **Dependencies** |
| :------: | :--------: | :--------------: | :--------: | :----------: | :-------------- | :--------------- |
| [3D Skin Layers](https://modrinth.com/mod/3dskinlayers) | [tr7zw](https://modrinth.com/user/tr7zw) | 1.21.7 | ✅ | 🟡 | Render the player skin layer in 3d. | [Fabric API](https://modrinth.com/mod/fabric-api) |
...
| [First-person Model](https://modrinth.com/mod/first-person-model) | [tr7zw](https://modrinth.com/user/tr7zw) | 1.21.7 | ❌ | 🟡 | Enables the third-person Model in first-person. | [Fabric API](https://modrinth.com/mod/fabric-api) |
...
| [Not Enough Animations](https://modrinth.com/mod/not-enough-animations) | [tr7zw](https://modrinth.com/user/tr7zw) | 1.21.7 | ✅ | 🟠 | Bringing first-person animations to the third-person. | [Fabric API](https://modrinth.com/mod/fabric-api) |
...
| [Particle Rain](https://modrinth.com/mod/particle-rain) | [PigCart](https://modrinth.com/user/PigCart) | 1.21.7 | ✅ | 🟡 | Replaces weather with prettier particle effects. | 🔸[Fabric API](https://modrinth.com/mod/fabric-api)<br> 🔸[Cloth Config API](https://modrinth.com/mod/cloth-config)<br> 🔸[*Mod Menu**](https://modrinth.com/mod/modmenu) |
...
| [Physics Mod](https://modrinth.com/mod/physicsmod) | [Haubna](https://www.patreon.com/c/Haubna/home) | 1.21.7 | ❌ | 🔴 | Adds physics in game. *The Pro Version can be dowloaded for free from the author's* [**Patreon**](https://www.patreon.com/c/Haubna/posts). | *none* |
| [Sodium Shadowy Path Blocks](https://modrinth.com/mod/sodium-shadowy-path-blocks) | [Rynnavinx](https://modrinth.com/user/Rynnavinx) | 1.21.7 | ✅ | 🟢 | Reintroduces vanilla-like smooth lighting to non-full blocks (e.g. dirt paths and how they have dark shading when directly next to a full block) when using Sodium. | [Sodium](https://modrinth.com/mod/sodium) |
...
| **Name** | **Author** | **Game Version** | **Status** | **Priority** | **Description** | **Dependencies** |
| :------: | :--------: | :--------------: | :--------: | :----------: | :-------------- | :--------------- |
| [Geophilic](https://modrinth.com/datapack/geophilic) | [bebebea_loste](https://modrinth.com/user/bebebea_loste) | 1.21.7 | ✅ | 🟠 | Improves vanilla Overworld biomes in a subtle and simple way. | *none* |
