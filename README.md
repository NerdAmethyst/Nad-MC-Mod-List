...
| [Cristel Lib](https://modrinth.com/mod/cristel-lib) | [Cristelknight](https://modrinth.com/user/Cristelknight) | 1.21.5 | ✅ | 🟠 | A Library mod for easy structure config and runtime datapacks. | [Fabric API](https://modrinth.com/mod/fabric-api) |
...
| [Entity Culling](https://modrinth.com/mod/entityculling) | [tr7zw](https://modrinth.com/user/tr7zw) | 1.21.5 | ✅ | 🟢 | Using async path-tracing to hide Block-/Entities that are not visible. | [Fabric API](https://modrinth.com/mod/fabric-api) |
...
| [Sodium Extra](https://modrinth.com/mod/sodium-extra) | [FlashyReese](https://modrinth.com/user/FlashyReese) | 1.21.5 | ✅ | 🟢 | A Sodium addon that adds features that shouldn't be in Sodium. | 🔸[Sodium](https://modrinth.com/mod/sodium)<br> 🔸[Reese's Sodium Options](https://modrinth.com/mod/reeses-sodium-options)<br> 🔸[Iris Shaders](https://modrinth.com/mod/iris) |
