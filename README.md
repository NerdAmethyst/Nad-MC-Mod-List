...
| [YetAnotherConfigLib (YACL)](https://modrinth.com/mod/yacl) | [isxander](https://modrinth.com/user/isxander) | 1.21.6 | ✅ | 🟢 | A builder-based configuration library for Minecraft. | [Fabric API](https://modrinth.com/mod/fabric-api) |
...
| **Name** | **Author** | **Game Version** | **Status** | **Priority** | **Description** | **Dependencies** |
| :------: | :--------: | :--------------: | :--------: | :----------: | :-------------- | :--------------- |
| [BadOptimizations](https://modrinth.com/mod/badoptimizations) | [thosea](https://modrinth.com/user/thosea) | 1.21.6 | ✅ | 🟢 | Optimization mod that focuses on things other than rendering. | *none* |
...
| [ImmediatelyFast](https://modrinth.com/mod/immediatelyfast) | [RaphiMC](https://modrinth.com/user/RaphiMC) | 1.21.6 | ✅ | 🟢 | Speed up immediate mode rendering in Minecraft. | *none* |
...
| [Lithium](https://modrinth.com/mod/lithium) | [jellysquid3](https://modrinth.com/user/jellysquid3 "Original Author")<br> [2No2Name](https://modrinth.com/user/2No2Name "Project Lead") | 1.21.6 | ✅ | 🟢 | No-compromises game logic optimization mod. Well-suited for clients and servers of all kinds. | *none* |
...
| [ServerCore](https://modrinth.com/mod/servercore) | [Wesley1808](https://modrinth.com/user/Wesley1808) | 1.21.6 | ✅ | 🟡 | A mod that aims to optimize the minecraft server. | *none* |
...
| [Scaffolding Drops Nearby](https://modrinth.com/mod/scaffolding-drops-nearby) | [Serilum](https://modrinth.com/user/Serilum) | 1.21.6 | ✅ | 🟡 | When breaking a scaffolding block, all chained blocks will drop at the block's position. | [Collective](https://modrinth.com/mod/collective) |
...
| [Physics Mod](https://modrinth.com/mod/physicsmod) | [Haubna](https://www.patreon.com/c/Haubna/home) | 1.21.6 | ❌ | 🔴 | Adds physics in game. *The Pro Version can be dowloaded for free from the author's* [**Patreon**](https://www.patreon.com/c/Haubna/posts). | *none* |
| []() | []() | REPLACE_VER | :----: | :------: | :---------- | []() |
