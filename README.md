...
| [Get It Together, Drops!](https://modrinth.com/mod/get-it-together-drops) | [bl4ckscor3](https://modrinth.com/user/bl4ckscor3) | 1.21.6 | ✅ | 🟢 | Adds tags and configuration options for defining how dropped items should combine. | 🔸[Fabric API](https://modrinth.com/mod/fabric-api)<br> 🔸[Cloth Config API](https://modrinth.com/mod/cloth-config) |
...
| [More Culling](https://modrinth.com/mod/moreculling) | [FX](https://modrinth.com/user/FX) | 1.21.6 | ✅ | 🟢 | A mod that changes how multiple types of culling are handled in order to improve performance. | [Cloth Config API](https://modrinth.com/mod/cloth-config) |
...
| [Sit](https://modrinth.com/mod/bl4cks-sit) | [bl4ckscor3](https://modrinth.com/user/bl4ckscor3) | 1.21.6 | ✅ | 🟡 | Allows you to sit on slabs and stairs. | 🔸[Fabric API](https://modrinth.com/mod/fabric-api)<br> 🔸[Cloth Config API](https://modrinth.com/mod/cloth-config) |
| []() | []() | REPLACE_VER | :----: | :------: | :---------- | []() |
...
| [Falling Leaves](https://modrinth.com/mod/fallingleaves) | [randommcsomethin](https://modrinth.com/user/randommcsomethin) | 1.21.6 | ❌ | 🟡 | Adds a neat little particle effect to leaf blocks. *The vanilla game added its own implementation of falling leaves. From 1.21.5, this mod will just add tweaks to the vanilla feature.* | 🔸[Fabric API](https://modrinth.com/mod/fabric-api)<br> 🔸[Cloth Config API](https://modrinth.com/mod/cloth-config)<br> 🔸[*Mod Menu**](https://modrinth.com/mod/modmenu) |
