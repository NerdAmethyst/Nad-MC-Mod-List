...
| [Ksyxis](https://modrinth.com/mod/ksyxis) | [VidTu](https://modrinth.com/user/VidTu) | 1.21.7 | ✅ | 🟢 | Speeds up world loading by not loading nearby chunks every time. | *none* |
...
| [Armor Poser](https://modrinth.com/mod/armor-poser) | [Mrbysco](https://modrinth.com/user/Mrbysco) | 1.21.7 | ✅ | 🟢 | Adds a GUI for armor stands in which you can configure it's pose and other properties. | 🔸[Fabric API](https://modrinth.com/mod/fabric-api)<br> 🔸[Cloth Config API](https://modrinth.com/mod/cloth-config) |
