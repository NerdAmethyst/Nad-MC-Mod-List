...
| [Lithostitched](https://modrinth.com/mod/lithostitched) | [Apollo](https://modrinth.com/user/Apollo) | 1.21.5 | ❌ | 🔴 | Library mod with new configurability and compatibility enhancements for worldgen. | *none* |
...
| [YetAnotherConfigLib (YACL)](https://modrinth.com/mod/yacl) | [isxander](https://modrinth.com/user/isxander) | 1.21.5 | ✅ | 🟢 | A builder-based configuration library for Minecraft. | [Fabric API](https://modrinth.com/mod/fabric-api) |
...
| [FerriteCore](https://modrinth.com/mod/ferrite-core) | [malte0811](https://modrinth.com/user/malte0811) | 1.21.5 | ✅ | 🟢 | Memory usage optimizations. | *none* |
| [Get It Together, Drops!](https://modrinth.com/mod/get-it-together-drops) | [bl4ckscor3](https://modrinth.com/user/bl4ckscor3) | 1.21.5 | ✅ | 🟢 | Adds tags and configuration options for defining how dropped items should combine. | 🔸[Fabric API](https://modrinth.com/mod/fabric-api)<br> 🔸[Cloth Config API](https://modrinth.com/mod/cloth-config) |
| [ImmediatelyFast](https://modrinth.com/mod/immediatelyfast) | [RaphiMC](https://modrinth.com/user/RaphiMC) | 1.21.5 | ✅ | 🟢 | Speed up immediate mode rendering in Minecraft. | *none* |
| [Ksyxis](https://modrinth.com/mod/ksyxis) | [VidTu](https://modrinth.com/user/VidTu) | 1.21.5 | ✅ | 🟢 | Speeds up world loading by not loading nearby chunks every time. | *none* |
| [Lithium](https://modrinth.com/mod/lithium) | [jellysquid3](https://modrinth.com/user/jellysquid3 "Original Author")<br> [2No2Name](https://modrinth.com/user/2No2Name "Project Lead") | 1.21.5 | ✅ | 🟢 | No-compromises game logic optimization mod. Well-suited for clients and servers of all kinds. | *none* |
...
| [Reese's Sodium Options](https://modrinth.com/mod/reeses-sodium-options) | [FlashyReese](https://modrinth.com/user/FlashyReese) | 1.21.5 | ✅ | 🟢 | Alternative Options Menu for Sodium. | 🔸[Sodium](https://modrinth.com/mod/sodium)<br> 🔸[Iris Shaders](https://modrinth.com/mod/iris)<br> 🔸[Sodium Extra](https://modrinth.com/mod/sodium-extra) |
| [ScalableLux](https://modrinth.com/mod/scalablelux) | [ishland](https://modrinth.com/user/ishland) | 1.21.5 | ❌ | 🟡 | A Fabric mod based on Starlight that improves the performance of light updates in Minecraft. | *none* |
| [ServerCore](https://modrinth.com/mod/servercore) | [Wesley1808](https://modrinth.com/user/Wesley1808) | 1.21.5 | ✅ | 🟡 | A mod that aims to optimize the minecraft server. | *none* |
| [Sodium](https://modrinth.com/mod/sodium) | [jellysquid3](https://modrinth.com/user/jellysquid3 "Project Lead")<br> [IMS](https://modrinth.com/user/IMS "Maintainer") | 1.21.5 | ✅ | 🟢 | The fastest and most compatible rendering optimization mod for Minecraft. | *none* |
...
| [FabricSkyBoxes](https://modrinth.com/mod/fabricskyboxes) | [AMereBagatelle](https://modrinth.com/user/AMereBagatelle) | Error | ❌ | 🔴 | Allows resource packs to define custom skyboxes. | [Fabric API](https://modrinth.com/mod/fabric-api) |
| []() | []() | REPLACE_VER | :----: | :------: | :---------- | []() |
