...
| [Entity Culling](https://modrinth.com/mod/entityculling) | [tr7zw](https://modrinth.com/user/tr7zw) | 1.21.6 | ✅ | 🟢 | Using async path-tracing to hide Block-/Entities that are not visible. | [Fabric API](https://modrinth.com/mod/fabric-api) |
| [FerriteCore](https://modrinth.com/mod/ferrite-core) | [malte0811](https://modrinth.com/user/malte0811) | 1.21.6 | ✅ | 🟢 | Memory usage optimizations. | *none* |
...
| [First-person Model](https://modrinth.com/mod/first-person-model) | [tr7zw](https://modrinth.com/user/tr7zw) | 1.21.5 | ❌ | 🟡 | Enables the third-person Model in first-person. | [Fabric API](https://modrinth.com/mod/fabric-api) |
...
| **Name** | **Author** | **Game Version** | **Status** | **Priority** | **Description** | **Dependencies** |
| :------: | :--------: | :--------------: | :--------: | :----------: | :-------------- | :--------------- |
| [Axiom](https://modrinth.com/mod/axiom) | [Moulberry](https://modrinth.com/user/Moulberry) | REPLACE_VER | ✅ | 🟢 | The all-in-one tool for editing Minecraft Worlds. | [Fabric API](https://modrinth.com/mod/fabric-api) |
...
| [Chunky](https://modrinth.com/plugin/chunky) | [pop4959](https://modrinth.com/user/pop4959) | REPLACE_VER | ❌ | 🟠 | Pre-generates chunks, quickly and efficiently. | [Fabric API](https://modrinth.com/mod/fabric-api) |
| [Controlling](https://modrinth.com/mod/controlling) | [jaredlll08](https://modrinth.com/user/jaredlll08) | REPLACE_VER | ✅ | 🟡 | Adds a search bar to the Key-Bindings menu. | 🔸[Fabric API](https://modrinth.com/mod/fabric-api)<br> 🔸[Searchables](https://modrinth.com/mod/searchables) |
| [e4mc](https://modrinth.com/mod/e4mc) | [vgskye](https://modrinth.com/user/vgskye) | REPLACE_VER | ❌ | 🟡 | Open a LAN server to anyone, anywhere, anytime. | [Fabric API](https://modrinth.com/mod/fabric-api) |
| [Fabrishot](https://modrinth.com/mod/fabrishot) | [ramidzkh](https://modrinth.com/user/ramidzkh) | REPLACE_VER | ❌ | 🟠 | Take insanely large screenshots. | 🔸[Fabric API](https://modrinth.com/mod/fabric-api)<br> 🔸[*Cloth Config API**](https://modrinth.com/mod/cloth-config)<br> 🔸[*Mod Menu**](https://modrinth.com/mod/modmenu) |
| [Flashback](https://modrinth.com/mod/flashback) | [Moulberry](https://modrinth.com/user/Moulberry) | REPLACE_VER | ✅ | 🟢 | Record your Minecraft gameplay, play it back and create stunning cinematic shots. *Incompatible with Replay Mod*.  | [Fabric API](https://modrinth.com/mod/fabric-api) |
| [Freecam](https://modrinth.com/mod/freecam) | [hashalite](https://modrinth.com/user/hashalite) | REPLACE_VER | ✅ | 🟢 | A highly customizable freecam mod. | 🔸[Fabric API](https://modrinth.com/mod/fabric-api)<br> 🔸[Cloth Config API](https://modrinth.com/mod/cloth-config)<br> 🔸[*Mod Menu**](https://modrinth.com/mod/modmenu) |
| [LAN World Plug-n-Play \(mcwifipnp\)](https://modrinth.com/mod/mcwifipnp) | [satxm](https://modrinth.com/user/satxm) | REPLACE_VER | ❌ | 🟡 | Enhance the vanilla "Open to LAN" Gui for listening port customization and removal of enforced authentication | [Fabric API](https://modrinth.com/mod/fabric-api) |
| [MiniHUD](https://modrinth.com/mod/minihud) | [masa](https://modrinth.com/user/masa) | REPLACE_VER | ❌ | 🟡 | A "mini F3" HUD mod, also with various overlays like light level, spawn chunks, slime chunks etc. | [MaLiLib](https://modrinth.com/mod/malilib) |
| [Mod Menu](https://modrinth.com/mod/modmenu) | []() | REPLACE_VER | :----: | :------: | :---------- | []() |
