...
| [Dynamic FPS](https://modrinth.com/mod/dynamic-fps) | [juliand665](https://modrinth.com/user/juliand665) | 1.21.6 | ✅ | 🟢 | Reduce resource usage while Minecraft is in the background or idle. | 🔸[Fabric API](https://modrinth.com/mod/fabric-api)<br> 🔸[*Mod Menu**](https://modrinth.com/mod/modmenu)<br> 🔸[*Cloth Config API**](https://modrinth.com/mod/cloth-config) |
...
| [Ksyxis](https://modrinth.com/mod/ksyxis) | [VidTu](https://modrinth.com/user/VidTu) | 1.21.6 | ✅ | 🟢 | Speeds up world loading by not loading nearby chunks every time. | *none* |
...
| [ScalableLux](https://modrinth.com/mod/scalablelux) | [ishland](https://modrinth.com/user/ishland) | 1.21.6 | ❌ | 🟡 | A Fabric mod based on Starlight that improves the performance of light updates in Minecraft. | *none* |
...
| [Sodium](https://modrinth.com/mod/sodium) | [jellysquid3](https://modrinth.com/user/jellysquid3 "Project Lead")<br> [IMS](https://modrinth.com/user/IMS "Maintainer") | 1.21.6 | ✅ | 🟢 | The fastest and most compatible rendering optimization mod for Minecraft. | *none* |
...
| [Physics Mod](https://modrinth.com/mod/physicsmod) | [Haubna](https://www.patreon.com/c/Haubna/home) | REPLACE_VER | ❌ | 🔴 | Adds physics in game. *The Pro Version can be dowloaded for free from the author's* [**Patreon**](https://www.patreon.com/c/Haubna/posts). | *none* |
| []() | []() | REPLACE_VER | :----: | :------: | :---------- | []() |
